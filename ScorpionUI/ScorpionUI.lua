...
local ScorpionLib = {}
function ScorpionLib:Notify(NotifyConfig)
...
function ScorpionLib:Start(GuiConfig)
    ...
    local Flags = ScorpionLib and ScorpionLib.Flags or {}
    ...
    function ScorpionLib:ToggleUI()
        Main.Visible = not Main.Visible
    end

    function ScorpionLib:CloseUI()
        SpeedGui:Destroy()
    ...
    MinimizeButton.Image = "rbxassetid://99406005425356"
    ...
    MinimizeButton.MouseButton1Click:Connect(ScorpionLib.ToggleUI)
